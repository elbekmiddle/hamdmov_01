  ...
  return (
    <div className="flex flex-col items-center px-4">
      ...
      <div className="w-full max-w-screen-md bg-[#dee2e6] rounded-2xl overflow-hidden mt-6">
        <img src="https://clarity-tailwind.preview.uideck.com/images/hero-01.png" alt="Hero" className="w-full" />
        <div className="p-4">
          <p className="text-sm text-blue-600 font-semibold">LIFESTYLE</p>
          <h2 className="text-xl font-bold mt-1">How to live a minimal lifestyle in 2025</h2>
      ...
      <div className="w-full max-w-screen-xl flex flex-col lg:flex-row gap-6 mt-10">
        ...
        <div className="flex-1 bg-[#dee2e6] rounded-2xl overflow-hidden">
          <img src="https://clarity-tailwind.preview.uideck.com/images/hero-02.png" alt="Tech" className="w-full" />
          <div className="p-4">
            <p className="text-sm text-green-600 font-semibold">TECHNOLOGY</p>
            <h2 className="text-xl font-bold mt-1">Top 10 AI Tools You Must Try in 2025</h2>
            <p className="text-sm text-gray-700 mt-2">
        ...
        {/* Right card */}
        <div className="flex-1 bg-[#dee2e6] rounded-2xl overflow-hidden">
          <img src="https://clarity-tailwind.preview.uideck.com/images/hero-03.png" alt="Travel" className="w-full" />
          <div className="p-4">
            <p className="text-sm text-orange-500 font-semibold">TRAVEL</p>
            <h2 className="text-xl font-bold mt-1">5 Hidden Travel Destinations in Central Asia</h2>
            <p className="text-sm text-gray-700 mt-2">
